...
class _ContactCardState extends State<ContactCard>
  ...
  static const Color _themeBlueDark = Color(0xFF2563EB);
  static const Color _themeBlueLight = Color(0xFF60A5FA);
        ...
        child: AnimatedScale(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: (widget.isSelected ? _themeBlue : _themeBlue)
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: RadialGradient(
                            colors: [
                              _themeBlue.withValues(alpha: 0.15),
                              _themeBlue.withValues(alpha: 0.0),
                            ],
                          ),
                        ),
                      ),
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              Colors.transparent,
                              (isDark ? Colors.white : _themeBlue)
                            ...
                            children: [
                              ...
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: _themeBlue.withValues(alpha: 0.4),
                                      blurRadius: 12,
                                      spreadRadius: 0,
                                    ),
                                  ],
                              ...
                              const Spacer(),
                              // Action buttons principaux (en haut à droite)
                              _ActionButton(
                          ...
                          if (widget.contact.cardSlug != null) ...[
                            ...
                            SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                icon: Icon(Icons.credit_card_rounded, color: _themeBlueDark, size: 16),
                                label: const Text('Voir la carte', style: TextStyle(fontSize: 12)),
                                style: OutlinedButton.styleFrom(
                                  foregroundColor: _themeBlueDark,
                                  side: BorderSide(color: _themeBlueDark.withValues(alpha: 0.3)),

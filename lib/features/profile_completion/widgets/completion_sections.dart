...
class _CompletionSectionsState extends State<CompletionSections> {
  ...
  Widget _buildEducationsSection(
    ...
    // Repliable comme Compétences/Réseaux sociaux/Centre d'intérêt — le
    // traitement "toujours visible + Voir tout" façon Expériences est
    // réservé à la carte publique (public_card_page.dart), pas à cette
    // page d'édition.
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
